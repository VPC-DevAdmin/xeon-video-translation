...
class AlignRestore(object):
    # CPU patch: upstream defaulted dtype to torch.float16. Many CPU
    # kernels (conv2d, upsample, some torchvision/PIL ops) don't support
    # fp16 natively and either fall back noisily or raise. Default to
    # float32; GPU callers can still pass dtype=torch.float16 explicitly.
